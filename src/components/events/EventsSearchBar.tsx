...
const EventsSearchBar = ({ value, onChange, placeholder }: EventsSearchBarProps) => (
  <div className="flex justify-end">
    <div className="relative w-full max-w-xs">
      <input
        ...
        className="px-3 py-2 rounded border border-white/20 bg-white/10 text-white w-full pr-10 h-10"
      />
      {value && (
        <button
          type="button"
